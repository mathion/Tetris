...
public class TetrisTests {
	...
	/**
	 * Tests the canMove method of the LShape class Creates a grid and places a
	 * LShape in multiple places and checks if the canMove method returns the
	 * expected value.
	 */
	@Test
	...
	/**
	 * Tests the canMove method of the Square class Creates a grid and places a
	 * square in multiple places and checks if the canMove method returns the
	 * expected value.
	 */
	@Test
	...
	/**
	 * Tests the move method from the Square class. Creates a grid and a square.
	 * Then moves the square around the board and checks the position of the square.
	 */
	@Test
	...
	/**
	 * Tests the checkRows method from the Grid class. Creates a grid full of
	 * squares except for two squares in the middle. Runs checkRows then checks
	 * every square on the grid for the correct color.
	 */
	@Test
